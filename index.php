...
<div class="col-6 col-lg-4">
    <h2>Project</h2>
    <p>Here we can create project update and delete project. </p>
    <p><a class="btn btn-secondary" href="/pms/admin/create_project.html" role="button">View details &raquo;</a></p>
</div><!--/span-->
<div class="col-6 col-lg-4">
    <h2>User</h2>
    <p>Here we can create user add user to project and remove project. </p>
    <p><a class="btn btn-secondary" href="/pms/admin/create_user.php" role="button">View details &raquo;</a></p>
</div><!--/span-->
<div class="col-6 col-lg-4">
    <h2>Notification</h2>
...
if($_SESSION['type']=='student'){
    header("Location:".$loc. "/pms/student");
